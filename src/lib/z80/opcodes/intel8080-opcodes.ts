...
export const INTEL_8080_OPCODES: Record<number, OpcodeHandler> = {
  ...
  0x46: () => ({ mnemonic: 'MOV', operands: 'B, M', bytes: [0x46], size: 1, comment: 'Move memory (HL) to B', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0x49: () => ({ mnemonic: 'MOV', operands: 'C, C', bytes: [0x49], size: 1, comment: 'Move C to C', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0x4E: () => ({ mnemonic: 'MOV', operands: 'C, M', bytes: [0x4E], size: 1, comment: 'Move memory (HL) to C', supportsIntel8080: true, supportsIntel8085: true }),
  0x4F: () => ({ mnemonic: 'MOV', operands: 'C, A', bytes: [0x4F], size: 1, comment: 'Move A to C', supportsIntel8080: true, supportsIntel8085: true }),

  // 0x50 - 0x5F (MOV instructions)
  ...
  0x52: () => ({ mnemonic: 'MOV', operands: 'D, D', bytes: [0x52], size: 1, comment: 'Move D to D', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0x56: () => ({ mnemonic: 'MOV', operands: 'D, M', bytes: [0x56], size: 1, comment: 'Move memory (HL) to D', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0x5B: () => ({ mnemonic: 'MOV', operands: 'E, E', bytes: [0x5B], size: 1, comment: 'Move E to E', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0x5E: () => ({ mnemonic: 'MOV', operands: 'E, M', bytes: [0x5E], size: 1, comment: 'Move memory (HL) to E', supportsIntel8080: true, supportsIntel8085: true }),
  0x5F: () => ({ mnemonic: 'MOV', operands: 'E, A', bytes: [0x5F], size: 1, comment: 'Move A to E', supportsIntel8080: true, supportsIntel8085: true }),

  // 0x60 - 0x6F (MOV instructions)
  ...
  0x64: () => ({ mnemonic: 'MOV', operands: 'H, H', bytes: [0x64], size: 1, comment: 'Move H to H', supportsIntel8080: true, supportsIntel8085: true }),
  0x65: () => ({ mnemonic: 'MOV', operands: 'H, L', bytes: [0x65], size: 1, comment: 'Move L to H', supportsIntel8080: true, supportsIntel8085: true }),
  0x66: () => ({ mnemonic: 'MOV', operands: 'H, M', bytes: [0x66], size: 1, comment: 'Move memory (HL) to H', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0x6D: () => ({ mnemonic: 'MOV', operands: 'L, L', bytes: [0x6D], size: 1, comment: 'Move L to L', supportsIntel8080: true, supportsIntel8085: true }),
  0x6E: () => ({ mnemonic: 'MOV', operands: 'L, M', bytes: [0x6E], size: 1, comment: 'Move memory (HL) to L', supportsIntel8080: true, supportsIntel8085: true }),
  0x6F: () => ({ mnemonic: 'MOV', operands: 'L, A', bytes: [0x6F], size: 1, comment: 'Move A to L', supportsIntel8080: true, supportsIntel8085: true }),

  // 0x70 - 0x7F (MOV instructions)
  0x70: () => ({ mnemonic: 'MOV', operands: 'M, B', bytes: [0x70], size: 1, comment: 'Move B to memory (HL)', supportsIntel8080: true, supportsIntel8085: true }),
  0x71: () => ({ mnemonic: 'MOV', operands: 'M, C', bytes: [0x71], size: 1, comment: 'Move C to memory (HL)', supportsIntel8080: true, supportsIntel8085: true }),
  0x72: () => ({ mnemonic: 'MOV', operands: 'M, D', bytes: [0x72], size: 1, comment: 'Move D to memory (HL)', supportsIntel8080: true, supportsIntel8085: true }),
  0x73: () => ({ mnemonic: 'MOV', operands: 'M, E', bytes: [0x73], size: 1, comment: 'Move E to memory (HL)', supportsIntel8080: true, supportsIntel8085: true }),
  0x74: () => ({ mnemonic: 'MOV', operands: 'M, H', bytes: [0x74], size: 1, comment: 'Move H to memory (HL)', supportsIntel8080: true, supportsIntel8085: true }),
  0x75: () => ({ mnemonic: 'MOV', operands: 'M, L', bytes: [0x75], size: 1, comment: 'Move L to memory (HL)', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0x7E: () => ({ mnemonic: 'MOV', operands: 'A, M', bytes: [0x7E], size: 1, comment: 'Move memory (HL) to A', supportsIntel8080: true, supportsIntel8085: true }),
  0x7F: () => ({ mnemonic: 'MOV', operands: 'A, A', bytes: [0x7F], size: 1, comment: 'Move A to A', supportsIntel8080: true, supportsIntel8085: true }),

  // 0x80 - 0x8F (Arithmetic operations)
  ...
  0x86: () => ({ mnemonic: 'ADD', operands: 'M', bytes: [0x86], size: 1, comment: 'Add memory (HL) to A', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0x8E: () => ({ mnemonic: 'ADC', operands: 'M', bytes: [0x8E], size: 1, comment: 'Add memory (HL) to A with carry', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0x96: () => ({ mnemonic: 'SUB', operands: 'M', bytes: [0x96], size: 1, comment: 'Subtract memory (HL) from A', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0x9E: () => ({ mnemonic: 'SBB', operands: 'M', bytes: [0x9E], size: 1, comment: 'Subtract memory (HL) from A with borrow', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0xA6: () => ({ mnemonic: 'ANA', operands: 'M', bytes: [0xA6], size: 1, comment: 'AND memory (HL) with A', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0xAE: () => ({ mnemonic: 'XRA', operands: 'M', bytes: [0xAE], size: 1, comment: 'XOR memory (HL) with A', supportsIntel8080: true, supportsIntel8085: true }),
  0xAF: () => ({ mnemonic: 'XRA', operands: 'A', bytes: [0xAF], size: 1, comment: 'XOR A with A', supportsIntel8080: true, supportsIntel8085: true }),

  // 0xB0 - 0xBF (Logical operations and Compare)
  ...
  0xB6: () => ({ mnemonic: 'ORA', operands: 'M', bytes: [0xB6], size: 1, comment: 'OR memory (HL) with A', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0xBE: () => ({ mnemonic: 'CMP', operands: 'M', bytes: [0xBE], size: 1, comment: 'Compare memory (HL) with A', supportsIntel8080: true, supportsIntel8085: true }),
  0xBF: () => ({ mnemonic: 'CMP', operands: 'A', bytes: [0xBF], size: 1, comment: 'Compare A with A', supportsIntel8080: true, supportsIntel8085: true }),

  // 0xC0 - 0xCF (Stack, Call, and Return operations)
  ...
  0xC7: () => ({ mnemonic: 'RST', operands: '0', bytes: [0xC7], size: 1, comment: 'Restart (call 0000h)', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0xCF: () => ({ mnemonic: 'RST', operands: '1', bytes: [0xCF], size: 1, comment: 'Restart (call 0008h)', supportsIntel8080: true, supportsIntel8085: true }),

  // 0xD0 - 0xDF (Stack, Call, and Return operations)
  ...
  0xD7: () => ({ mnemonic: 'RST', operands: '2', bytes: [0xD7], size: 1, comment: 'Restart (call 0010h)', supportsIntel8080: true, supportsIntel8085: true }),
  0xD8: () => ({ mnemonic: 'RC', operands: '', bytes: [0xD8], size: 1, comment: 'Return if carry', supportsIntel8080: true, supportsIntel8085: true }),
  // 0xD9 is not used in 8080
  0xDA: (bytes, i) => {
    const value = bytes[i+1] | (bytes[i+2] << 8);
    return {
      mnemonic: 'JC', 
  ...
  0xDF: () => ({ mnemonic: 'RST', operands: '3', bytes: [0xDF], size: 1, comment: 'Restart (call 0018h)', supportsIntel8080: true, supportsIntel8085: true }),

  // 0xE0 - 0xEF (Stack, Call, and Return operations)
  ...
  0xE7: () => ({ mnemonic: 'RST', operands: '4', bytes: [0xE7], size: 1, comment: 'Restart (call 0020h)', supportsIntel8080: true, supportsIntel8085: true }),
  ...
  0xEF: () => ({ mnemonic: 'RST', operands: '5', bytes: [0xEF], size: 1, comment: 'Restart (call 0028h)', supportsIntel8080: true, supportsIntel8085: true }),

  // 0xF0 - 0xFF (Stack, Call, and Return operations)
  0xF0: () => ({ mnemonic: 'RP', operands: '', bytes: [0xF0], size: 1, comment: 'Return if plus (positive)', supportsIntel8080: true, supportsIntel8085: true }),
  0xF1: () => ({ mnemonic: 'POP', operands: 'PSW', bytes: [0xF1], size: 1, comment: 'Pop processor status word (A and flags)', supportsIntel8080: true, supportsIntel8085: true }),
  0xF2: (bytes, i) => {
    const value = bytes[i+1] | (bytes[i+2] << 8);
    return {
      mnemonic: 'JP', 
  ...
  0xF4: (bytes, i) => {
    ...
    return {
      ...
      size: 3,
      comment: 'Call if plus (positive)',
      supportsIntel8080: true, 
      supportsIntel8085: true,
      targetAddress: value
    };
  },
  0xF5: () => ({ mnemonic: 'PUSH', operands: 'PSW', bytes: [0xF5], size: 1, comment: 'Push processor status word (A and flags)', supportsIntel8080: true, supportsIntel8085: true }),
  0xF6: (bytes, i) => ({
    mnemonic: 'ORI', 
    operands: formatByteValue(bytes[i+1]), 
  ...
  0xF7: () => ({ mnemonic: 'RST', operands: '6', bytes: [0xF7], size: 1, comment: 'Restart (call 0030h)', supportsIntel8080: true, supportsIntel8085: true }),
  0xF8: () => ({ mnemonic: 'RM', operands: '', bytes: [0xF8], size: 1, comment: 'Return if minus (negative)', supportsIntel8080: true, supportsIntel8085: true }),
  0xF9: () => ({ mnemonic: 'SPHL', operands: '', bytes: [0xF9], size: 1, comment: 'Load SP from HL', supportsIntel8080: true, supportsIntel8085: true }),
  0xFA: (bytes, i) => {
    const value = bytes[i+1] | (bytes[i+2] << 8);
    return {
      mnemonic: 'JM', 
      ...
      size: 3,
      comment: 'Jump if minus (negative)',
      supportsIntel8080: true, 
      supportsIntel8085: true,
      targetAddress: value
    };
  ...
  0xFC: (bytes, i) => {
    ...
    return {
      ...
      size: 3,
      comment: 'Call if minus (negative)',
      supportsIntel8080: true, 
      supportsIntel8085: true,
      targetAddress: value
    };
  },
  // 0xFD is not used in 8080
  0xFE: (bytes, i) => ({
    mnemonic: 'CPI', 
    operands: formatByteValue(bytes[i+1]), 
  ...
  0xFF: () => ({ mnemonic: 'RST', operands: '7', bytes: [0xFF], size: 1, comment: 'Restart (call 0038h)', supportsIntel8080: true, supportsIntel8085: true }),
};
