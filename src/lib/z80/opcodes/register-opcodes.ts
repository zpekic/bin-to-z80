...
export const REGISTER_OPCODES: Record<number, OpcodeHandler> = {
  ...
  0x50: () => ({ mnemonic: 'LD', operands: 'D, B', bytes: [0x50], size: 1 }),
  0x51: () => ({ mnemonic: 'LD', operands: 'D, C', bytes: [0x51], size: 1 }),
  0x52: () => ({ mnemonic: 'LD', operands: 'D, D', bytes: [0x52], size: 1 }),
  0x53: () => ({ mnemonic: 'LD', operands: 'D, E', bytes: [0x53], size: 1 }),
  0x54: () => ({ mnemonic: 'LD', operands: 'D, H', bytes: [0x54], size: 1 }),
  0x55: () => ({ mnemonic: 'LD', operands: 'D, L', bytes: [0x55], size: 1 }),
  0x56: () => ({ mnemonic: 'LD', operands: 'D, (HL)', bytes: [0x56], size: 1 }),
  0x57: () => ({ mnemonic: 'LD', operands: 'D, A', bytes: [0x57], size: 1 }),
  
  0x58: () => ({ mnemonic: 'LD', operands: 'E, B', bytes: [0x58], size: 1 }),
  0x59: () => ({ mnemonic: 'LD', operands: 'E, C', bytes: [0x59], size: 1 }),
  0x5A: () => ({ mnemonic: 'LD', operands: 'E, D', bytes: [0x5A], size: 1 }),
  0x5B: () => ({ mnemonic: 'LD', operands: 'E, E', bytes: [0x5B], size: 1 }),
  0x5C: () => ({ mnemonic: 'LD', operands: 'E, H', bytes: [0x5C], size: 1 }),
  0x5D: () => ({ mnemonic: 'LD', operands: 'E, L', bytes: [0x5D], size: 1 }),
